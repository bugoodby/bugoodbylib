...
//				LOG("cell(" + r + "," + c + ") = " + sheet.Cells(r, c).Value);
				if ( sheet.Cells(r, c).MergeCells ) {
					LOG("   # マージされています TopLeft=" + sheet.Cells(r, c).MergeArea.Item(1).Address
						+ " (" + sheet.Cells(r, c).MergeArea.Item(1).Row
						+ "," + sheet.Cells(r, c).MergeArea.Item(1).Column + ")");
				}
			}
		}
	}
